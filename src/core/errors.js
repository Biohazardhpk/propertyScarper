...
export class ProviderRateLimitError extends ProviderError { constructor(message, retryAfterMs = 0) { super(message, 'RATE_LIMITED'); this.retryAfterMs = retryAfterMs; } }
